...
<div class="screen active" id="s-auth">
  <div class="aw">
    ...
    <div style="width:100%;display:none" id="otpStep">
      <p style="text-align:center;font-size:.84rem;color:var(--sb);margin-bottom:16px">OTP sent to <strong id="otpTo"></strong></p>
...
window.sendOTP=async function(){
  ...
  try{
    ...
    if(r.dev_otp)toast('🔐 Dev OTP: '+r.dev_otp); else toast('📱 OTP sent!');
